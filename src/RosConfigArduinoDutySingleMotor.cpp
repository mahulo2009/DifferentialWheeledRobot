...
void RosConfigArduinoDutySingleMotor::read(ros::NodeHandle &nh)
{
    ...
    nh.getParam("/robomat/pin_power_left", &this->pin_power); 
    nh.getParam("/robomat/pin_power_right", &this->pin_power);
    ...
    nh.getParam("/robomat/pin_encoder_left", &this->pin_encoder);
    nh.getParam("/robomat/pin_encoder_right", &this->pin_encoder);
    nh.getParam("/robomat/pin_direction_left", &this->pin_direction);
    nh.getParam("/robomat/pin_direction_right", &this->pin_direction);        
}
